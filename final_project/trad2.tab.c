...
{
       0,    66,    66,    68,    72,    74,    78,    82,    85,    86,
      87,    88,    90,    92,    97,   100,   102,   105,   107,   110,
     115,   117,   122,   126,   127,   129,   131,   133,   138,   139,
     142,   148,   151,   153
};
#endif
...
static const char *const yytname[] =
{
  ...
  "';'", "'('", "')'", "'{'", "'}'", "','", "'$'", "$accept", "axioma",
  "def_variables", "r_variables", "def_funciones", "iniciar", "sentencia",
  "r_sentencias", "v_global", "v_asignacion", "v_multiple", "impresion",
  "r_impresion", "asignacion", "expresion", "termino", "operando", YY_NULLPTR
};
#endif
...
{
       4,     9,    14,    17,    15,     7,   -28,    13,   -28,   -28,
       4,    32,    16,    20,   -28,   -28,   -28,    30,   -28,    21,
       7,     1,   -28,   -28,    36,    24,    24,    22,    33,    35,
      27,   -28,   -28,   -28,    50,   -28,   -28,    22,   -28,   -28,
     -28,    42,    22,     1,   -28,    22,    22,    22,    22,    50,
     -28,    31,   -28,   -10,   -10,   -28,   -28,   -28,    22,   -28,
      31,   -28
};
...
{
       0,     0,     0,     0,     0,    15,     1,     0,     2,     6,
       5,     0,    17,     0,     4,     3,    16,     0,    14,     0,
      15,    12,    18,    32,    31,     0,     0,     0,     0,     0,
       0,    11,    10,     9,     8,    23,    28,     0,    31,    29,
      30,     0,     0,    12,     7,     0,     0,     0,     0,    22,
      33,     0,    13,    24,    25,    26,    27,    21,     0,    19,
       0,    20
};
...
{
      -1,     2,     3,    15,     8,     9,    29,    30,     4,    12,
      18,    32,    59,    33,    34,    35,    36
};
...
{
      41,    31,    47,    48,    23,    24,     1,    39,    40,     1,
      49,    25,    26,     5,     6,    51,    11,    27,    53,    54,
      55,    56,    28,    31,     7,    23,    38,    23,    38,    13,
      10,    60,    25,    26,    20,    16,    17,    19,    27,    21,
      27,    45,    46,    47,    48,    37,    44,    14,    57,    42,
      43,    58,    45,    46,    47,    48,    61,     0,    22,    50,
      45,    46,    47,    48,     0,     0,    52
};

static const yytype_int8 yycheck[] =
{
      27,    21,    12,    13,     3,     4,     5,    25,    26,     5,
      37,    10,    11,     4,     0,    42,     9,    16,    45,    46,
      47,    48,    21,    43,     7,     3,     4,     3,     4,    16,
      15,    58,    10,    11,     4,     3,    20,    17,    16,    18,
      16,    10,    11,    12,    13,     9,    19,    10,    17,    16,
      15,    20,    10,    11,    12,    13,    60,    -1,    20,    17,
      10,    11,    12,    13,    -1,    -1,    43
};
...
{
       0,     5,    23,    24,    30,     4,     0,     7,    26,    27,
      15,     9,    31,    16,    24,    25,     3,    20,    32,    17,
       4,    18,    31,     3,     4,    10,    11,    16,    21,    28,
      29,    30,    33,    35,    36,    37,    38,     9,     4,    38,
      38,    36,    16,    15,    19,    10,    11,    12,    13,    36,
      17,    36,    29,    36,    36,    36,    36,    17,    20,    34,
      36,    34
};
...
#line 1408 "trad2.tab.c"
  ...
  case 6:
#line 78 "trad2.y"
                                           { sprintf (temp, "(defun %s)", (yyvsp[0].cadena));
                                            (yyval.cadena) = genera_cadena (temp) ;}
#line 1415 "trad2.tab.c"
  ...
  case 7:
#line 82 "trad2.y"
                                                   { sprintf (temp, "%s () \n %s", (yyvsp[-5].cadena), (yyvsp[-1].cadena));
                                                  (yyval.cadena) = genera_cadena (temp) ;}
...
#line 1488 "trad2.tab.c"
  ...
  case 18:
#line 107 "trad2.y"
                                                    { sprintf (temp, "( setq %s %s )", (yyvsp[-1].cadena), (yyvsp[0].cadena));
                                                      (yyval.cadena) = genera_cadena (temp) ; }
