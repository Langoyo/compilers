...
argumento: expresion r_impresion                     {sprintf (temp, "( print %s ) %s" , $1, $2 );
            ...
            | IDENTIF '['expresion_aritm']' r_impresion       {sprintf (temp, "( print ( aref %s %s) ) %s" , $1, $3, $5 );
                                                      $$ = genera_cadena (temp) ;}
            ;
