...
#line 360 "trad1.y"
                                                  ...
                                                  (yyval.cadena) = genera_cadena (temp) ; }
#line 2194 "trad1.tab.c"
    break;

  case 83:
#line 363 "trad1.y"
                                                                        { (yyval.cadena) = (yyvsp[0].cadena) ;}
#line 2200 "trad1.tab.c"
    break;
...
#line 390 "trad1.y"
                                                        {  sprintf (temp, "( OR %s %s )" , (yyvsp[-2].cadena), (yyvsp[0].cadena));
                                                  (yyval.cadena) = genera_cadena (temp) ; }
#line 2291 "trad1.tab.c"
    break;

  case 97:
#line 394 "trad1.y"
                                                                    { (yyval.cadena) = (yyvsp[0].cadena); }
#line 2297 "trad1.tab.c"
    break;
...
#line 409 "trad1.y"
                                                { sprintf (temp, " %s ", (yyvsp[-1].cadena)) ;
                                          (yyval.cadena) = genera_cadena (temp) ; }
#line 2333 "trad1.tab.c"
    break;

  case 103:
#line 411 "trad1.y"
                                        {  (yyval.cadena) = (yyvsp[0].cadena); }
#line 2339 "trad1.tab.c"
    break;
