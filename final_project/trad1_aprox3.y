...
%type   <cadena> impresion expresion termino operando sentencia axioma asignacion
...
impresion:      '#' expresion                   {sprintf (temp, "( print %s ) " , $2 );
                                                  $$ = genera_cadena (temp) ;}

asignacion: VARIABLE '=' expresion              { sprintf (temp, "( setq %c %s ) " , $1 + 'a', $3);
                                                  $$ = genera_cadena (temp) ; }         
            ;            
