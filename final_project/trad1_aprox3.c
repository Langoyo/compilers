...
static const yytype_int8 yyrline[] =
{
      ...
      86,    90,    91,    93,    95,    97,   102,   103,   106,   112,
     115,   116
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'-'", "'*'", "'/'", "SIGNO_UNARIO", "'\\n'", "'#'", "'('", "')'",
  "$accept", "axioma", "$@1", "r_expr", "sentencia", "impresion",
...
{
      -1,    -8,     5,    10,    10,    18,    18,    30,    -7,    -8,
      -8,    29,    -8,    -8,    18,    -8,    -8,    -8,    29,    20,
      -8,    -8,    18,    18,    18,    18,    29,    -8,    -1,     7,
       7,    -8,    -8,    -8,    -8
};
...
{
       0,    20,    19,     0,     0,     0,     0,     0,     0,     8,
       7,     6,    11,    16,     0,    19,    17,    18,     9,     0,
...
{
      18,    19,     1,     2,    21,     3,     4,    16,    17,    26,
      14,     5,     6,     1,    15,    24,    25,    29,    30,    31,
      32,     1,    15,     6,     3,     4,    22,    23,    24,    25,
      20,     6,     0,     0,    27,    22,    23,    24,    25,    33
};

static const yytype_int8 yycheck[] =
{
       5,     6,     3,     4,    11,     6,     7,     3,     4,    14,
       5,    12,    13,     3,     4,     8,     9,    22,    23,    24,
      25,     3,     4,    13,     6,     7,     6,     7,     8,     9,
       0,    13,    -1,    -1,    14,     6,     7,     8,     9,    28
};
...
{
       0,     3,     4,     6,     7,    12,    13,    16,    19,    20,
      21,    22,    23,    24,     5,     4,    24,    24,    22,    22,
       0,    11,     6,     7,     8,     9,    22,    14,    17,    22,
      22,    22,    22,    16,    18
};
...
#line 1392 "trad1.tab.c"
  ...
  case 10:
#line 86 "trad1.y"
                                                { sprintf (temp, "( setq %c %s ) " , (yyvsp[-2].indice) + 'a', (yyvsp[0].cadena));
                                                  (yyval.cadena) = genera_cadena (temp) ; }
